...
\item Developed Query Prefix Match algorithm resulted in 6.1\% DTR increase in Russia (+10k volume/day).
\item Also worked on Query Augmentation, Correction and Shortname Match algorithms to improve recall. Overall DTR and Revenue change 1.7\% and 8.6\% respectively. 
\item 
\end{zitemize}
